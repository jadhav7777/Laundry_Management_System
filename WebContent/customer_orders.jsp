...
<%  if(resultSet.getString("status").equals("done") )
 ...
 <%  }
	  ...
	  %>
	 <td><a href="update_order.jsp?id=<%=resultSet.getString("id")%>&status=<%=status1%> ">Update</a></td>
	  <% }%> 
...
<%  if(resultSet.getString("status").equals("done") )
 ...
 <%  }
	  ...
	  %>
	 <td><a href="update_order.jsp?id=<%=resultSet.getString("id")%>&status=<%=status2%> ">Update</a></td>
	  <% }%> 
