...
public class Payment_servlet extends HttpServlet {
	...
	ServletException, IOException {
		...
		try {
			...
			String query="insert into orderclothes1 values('"+id+"','"+mobileno+"','"+service+"','"+shirts+"','"+tshirts+"','"+jeans+"','"+trousers+"','"+sarees+"','"+totalamount+"','"+pickupdate+"','"+pickupt+"','"+city+"','"+pincode+"','"+address+"','"+landmark+"','"+status+"');";
		...
		response.sendRedirect("home1.jsp");
			...
			try {
				...
				String query="insert into orderothers1 values('"+id+"','"+mobileno+"','"+service+"','"+helmet+"','"+shoes+"','"+pickupdate+"','"+pickupt+"','"+totalamount+"','"+city+"','"+pincode+"','"+address+"','"+landmark+"','"+status+"');";
				 ps=connection.prepareStatement(query);
				 ps.executeUpdate();
		} catch (Exception e) {
			 System.err.println(e);
